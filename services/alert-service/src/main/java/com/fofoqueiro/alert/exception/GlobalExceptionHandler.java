// @path services/alert-service/src/main/java/com/fofoqueiro/alert/exception/GlobalExceptionHandler.java
// @owner alert-service
...
package com.fofoqueiro.alert.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneral(Exception ex, WebRequest request) {
        log.error("Erro não tratado em alert-service: {}", ex.getMessage(), ex);
