// @path services/audit-service/src/main/java/com/fofoqueiro/audit/exception/GlobalExceptionHandler.java
// @owner audit-service
...
package com.fofoqueiro.audit.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneral(Exception ex, WebRequest request) {
        log.error("Erro não tratado em audit-service: {}", ex.getMessage(), ex);
