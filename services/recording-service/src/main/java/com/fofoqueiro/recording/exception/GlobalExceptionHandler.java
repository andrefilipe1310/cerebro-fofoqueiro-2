// @path services/recording-service/src/main/java/com/fofoqueiro/recording/exception/GlobalExceptionHandler.java
...
package com.fofoqueiro.recording.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneral(Exception ex, WebRequest request) {
        log.error("Erro não tratado em recording-service: {}", ex.getMessage(), ex);
