// @path services/tenant-service/src/main/java/com/fofoqueiro/tenant/exception/GlobalExceptionHandler.java
...
package com.fofoqueiro.tenant.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneral(Exception ex, WebRequest request) {
        log.error("Erro não tratado em tenant-service: {}", ex.getMessage(), ex);
